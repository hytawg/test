...
import type { CanvasSettings, CameraSettings, AudioSettings, RecordingSettings, CaptureSource } from './types'
  ...
  return (
    <div className="flex h-screen bg-surface-950 text-white overflow-hidden select-none">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Titlebar */}
        <div
          className="h-10 shrink-0 flex items-center justify-center [-webkit-app-region:drag]"
        >

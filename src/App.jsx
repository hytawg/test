...
const STROKE_DATA = {
  ...
  // ── カタカナ書き順データ ──────────────────────────────────────
  "ア":[SD("M35,28 L72,28",35,28), SD("M54,16 C60,44 46,70 18,93",54,16)],
  "イ":[SD("M45,20 L28,65",45,20), SD("M65,16 L65,88",65,16)],
  "ウ":[SD("M45,19 L64,19",45,19), SD("M28,34 C22,54 26,74 48,90",28,34), SD("M80,34 C84,54 78,74 54,90",80,34)],
  "エ":[SD("M22,32 L86,32",22,32), SD("M54,32 L54,77",54,32), SD("M20,77 L88,77",20,77)],
  "オ":[SD("M22,32 L86,32",22,32), SD("M54,20 L54,90",54,20), SD("M60,56 C68,68 66,82 54,93",60,56)],
  "カ":[SD("M32,20 L32,90",32,20), SD("M32,47 L80,44 C80,58 65,74 42,92",32,47)],
  "キ":[SD("M20,33 L88,33",20,33), SD("M20,58 L88,58",20,58), SD("M54,22 L54,92",54,22)],
  "ク":[SD("M46,22 C62,28 76,40 80,57",46,22), SD("M32,47 C38,64 36,78 20,93",32,47)],
  "ケ":[SD("M28,18 L28,90",28,18), SD("M28,46 L76,38",28,46), SD("M64,38 L64,90",64,38)],
  "コ":[SD("M26,24 L84,24 L84,87",26,24), SD("M26,87 L84,87",26,87)],
  "サ":[SD("M36,30 L56,30",36,30), SD("M62,22 L62,50",62,22), SD("M54,50 C58,68 44,82 22,94",54,50)],
  "シ":[SD("M28,44 C26,54 28,62 32,66",28,44), SD("M46,30 C44,42 46,52 50,58",46,30), SD("M74,20 C84,46 76,68 52,90",74,20)],
  "ス":[SD("M20,28 L89,28",20,28), SD("M60,28 C68,54 52,74 26,92",60,28)],
  "セ":[SD("M58,22 L58,70 L26,70",58,22), SD("M20,46 L89,46",20,46)],
  "ソ":[SD("M36,24 C34,36 36,48 42,56",36,24), SD("M68,18 C76,44 66,70 38,91",68,18)],
  "タ":[SD("M20,30 L88,30",20,30), SD("M56,20 C62,40 56,60 40,78",56,20), SD("M38,60 C50,66 60,72 64,84",38,60)],
  "チ":[SD("M20,32 L88,32",20,32), SD("M20,56 L88,56",20,56), SD("M58,56 C62,72 50,84 36,93",58,56)],
  "ツ":[SD("M26,32 C24,42 26,50 30,56",26,32), SD("M46,24 C44,36 46,46 50,54",46,24), SD("M76,18 C84,44 74,68 50,90",76,18)],
  "テ":[SD("M20,30 L88,30",20,30), SD("M54,30 L54,60",54,30), SD("M28,60 L80,60",28,60)],
  "ト":[SD("M44,18 L44,90",44,18), SD("M44,47 L78,58",44,47)],
  "ナ":[SD("M20,40 L88,40",20,40), SD("M54,22 L54,92",54,22)],
  "ニ":[SD("M30,34 L80,34",30,34), SD("M20,72 L88,72",20,72)],
  "ヌ":[SD("M20,32 L89,32",20,32), SD("M74,22 C62,48 44,64 22,78 C28,86 52,92 74,88",74,22)],
  "ネ":[SD("M20,30 L88,30",20,30), SD("M54,18 L54,64",54,18), SD("M32,56 C36,68 34,80 26,91",32,56), SD("M76,56 C72,68 68,80 74,91",76,56)],
  "ノ":[SD("M28,16 C40,44 58,68 82,93",28,16)],
  "ハ":[SD("M32,28 C26,52 22,72 30,90",32,28), SD("M70,22 C76,46 74,68 60,88",70,22)],
  "ヒ":[SD("M26,22 L26,90",26,22), SD("M26,56 C48,46 68,50 76,62 C78,74 66,84 44,91",26,56)],
  "フ":[SD("M20,28 L86,28 C86,50 72,68 46,88",20,28)],
  "ヘ":[SD("M16,60 C36,28 68,22 92,50",16,60)],
  "ホ":[SD("M20,38 L88,38",20,38), SD("M54,22 L54,90",54,22), SD("M32,66 C26,78 24,87 32,92",32,66), SD("M76,66 C80,78 82,87 74,92",76,66)],
  "マ":[SD("M20,30 L88,30",20,30), SD("M62,30 C64,54 50,72 26,91",62,30)],
  "ミ":[SD("M34,28 L70,28",34,28), SD("M26,54 L82,54",26,54), SD("M24,78 C44,72 66,74 86,82",24,78)],
  "ム":[SD("M54,20 C52,40 40,58 20,72",54,20), SD("M20,72 C38,72 62,76 90,93",20,72)],
  "メ":[SD("M26,26 C42,48 54,66 56,89",26,26), SD("M84,22 C68,44 48,60 20,78",84,22)],
  "モ":[SD("M20,30 L88,30",20,30), SD("M20,56 L88,56",20,56), SD("M54,56 L54,88 C54,91 44,94 36,91",54,56)],
  "ヤ":[SD("M28,46 C34,38 48,32 58,32",28,46), SD("M58,22 L58,91",58,22), SD("M20,46 L58,46",20,46)],
  "ユ":[SD("M20,36 L88,36",20,36), SD("M84,36 L84,82 L20,82",84,36)],
  "ヨ":[SD("M26,22 L84,22 L84,54",26,22), SD("M26,54 L84,54 L84,86",26,54), SD("M26,86 L84,86",26,86)],
  "ラ":[SD("M20,30 L88,30",20,30), SD("M64,30 C70,52 58,72 30,91",64,30)],
  "リ":[SD("M36,20 C32,46 28,68 34,88",36,20), SD("M70,18 L70,78 C70,87 60,92 50,90",70,18)],
  "ル":[SD("M26,22 C24,50 22,70 30,88",26,22), SD("M64,22 C62,44 70,60 84,72 C84,82 74,88 58,90",64,22)],
  "レ":[SD("M34,22 L34,78 C34,86 48,92 66,88",34,22)],
  "ロ":[SD("M26,22 L84,22 L84,87",26,22), SD("M26,22 L26,87",26,22), SD("M26,87 L84,87",26,87)],
  "ワ":[SD("M20,32 L88,32",20,32), SD("M64,32 C66,54 56,72 34,91",64,32)],
  "ヲ":[SD("M20,26 L88,26",20,26), SD("M20,52 L88,52",20,52), SD("M56,52 C58,68 46,80 24,91",56,52)],
  "ン":[SD("M44,26 C42,38 44,50 50,58",44,26), SD("M74,20 C60,48 42,68 20,88",74,20)],
  // 濁点付きカタカナ（ dakuten = 上部右の短い2画 ）
  "ガ":[SD("M32,20 L32,90",32,20), SD("M32,47 L80,44 C80,58 65,74 42,92",32,47), SD("M80,14 C82,18 80,24 78,26",80,14), SD("M86,9 C88,13 86,19 84,21",86,9)],
  "ジ":[SD("M28,44 C26,54 28,62 32,66",28,44), SD("M46,30 C44,42 46,52 50,58",46,30), SD("M74,20 C84,46 76,68 52,90",74,20), SD("M80,14 C82,18 80,24 78,26",80,14), SD("M86,9 C88,13 86,19 84,21",86,9)],
  "ズ":[SD("M20,28 L89,28",20,28), SD("M60,28 C68,54 52,74 26,92",60,28), SD("M80,14 C82,18 80,24 78,26",80,14), SD("M86,9 C88,13 86,19 84,21",86,9)],
  "ザ":[SD("M36,30 L56,30",36,30), SD("M62,22 L62,50",62,22), SD("M54,50 C58,68 44,82 22,94",54,50), SD("M80,14 C82,18 80,24 78,26",80,14), SD("M86,9 C88,13 86,19 84,21",86,9)],
  "ゼ":[SD("M58,22 L58,70 L26,70",58,22), SD("M20,46 L89,46",20,46), SD("M80,14 C82,18 80,24 78,26",80,14), SD("M86,9 C88,13 86,19 84,21",86,9)],
  "ゾ":[SD("M36,24 C34,36 36,48 42,56",36,24), SD("M68,18 C76,44 66,70 38,91",68,18), SD("M80,14 C82,18 80,24 78,26",80,14), SD("M86,9 C88,13 86,19 84,21",86,9)],
};

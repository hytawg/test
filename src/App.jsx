...
const STROKE_DATA = {
  // ア行
  "あ":[SD("M25,26 L70,26",25,26), SD("M12,46 L88,46",12,46), SD("M62,28 C72,40 76,56 64,70 C52,84 28,84 18,72 C10,60 16,46 28,44",62,28)],
  "い":[SD("M36,18 C33,35 30,56 34,80",36,18), SD("M65,16 C62,32 57,54 48,72 C44,80 40,83 36,83",65,16)],
  "う":[SD("M36,26 L64,26",36,26), SD("M50,26 C62,32 72,48 66,62 C60,74 46,82 32,78",50,26)],
  "え":[SD("M18,28 L82,28",18,28), SD("M50,28 C52,36 56,46 62,54",50,28), SD("M16,58 C30,48 60,46 76,58 C82,66 78,80 64,86 C50,92 34,88 24,78",16,58)],
  "お":[SD("M28,22 L72,22",28,22), SD("M14,46 L86,46",14,46), SD("M50,22 C58,36 60,56 52,70 C46,82 36,88 26,84",50,22)],
  // カ行
  "か":[SD("M26,18 L26,82",26,18), SD("M18,50 L82,50",18,50), SD("M64,18 C70,32 70,56 60,70 C52,82 42,86 36,84",64,18)],
  "き":[SD("M18,24 L82,24",18,24), SD("M18,46 L82,46",18,46), SD("M50,24 C54,32 54,40 50,48",50,24), SD("M36,58 C24,66 18,78 26,86 C34,92 52,90 64,82 C74,74 76,62 64,54 C56,48 40,50 36,58",36,58)],
  "く":[SD("M68,16 C76,28 76,50 62,64 C52,74 38,80 26,82",68,16)],
  "け":[SD("M26,18 L26,82",26,18), SD("M26,46 L74,34",26,46), SD("M74,34 L74,82",74,34)],
  "こ":[SD("M16,28 L84,28",16,28), SD("M16,72 L84,72",16,72)],
  // サ行
  "さ":[SD("M18,28 L82,28",18,28), SD("M18,52 L82,52",18,52), SD("M55,28 C62,44 60,62 50,74 C42,84 32,88 24,84",55,28)],
  "し":[SD("M50,18 C52,36 54,58 50,72 C46,82 38,88 28,86",50,18)],
  "す":[SD("M18,28 L82,28",18,28), SD("M50,16 C52,30 54,54 50,68 C46,78 38,82 30,76",50,16)],
  "せ":[SD("M28,18 L28,82",28,18), SD("M18,46 L82,46",18,46), SD("M28,46 C44,36 70,36 78,48 C82,56 78,70 58,74 C46,76 34,74 28,66",28,46)],
  "そ":[SD("M20,30 C36,22 64,22 80,30 C86,36 82,46 70,50",20,30), SD("M50,50 C62,58 68,70 60,80 C52,88 36,88 26,78",50,50)],
  // タ行
  "た":[SD("M18,28 L82,28",18,28), SD("M50,16 L50,52",50,16), SD("M28,52 L72,52",28,52), SD("M64,52 C72,64 70,76 58,84 C48,90 38,90 32,84",64,52)],
  "ち":[SD("M18,26 L82,26",18,26), SD("M55,18 C64,32 66,50 56,64 C48,76 36,80 26,76 C18,70 16,58 22,50 C28,40 44,36 58,42",55,18)],
  "つ":[SD("M72,22 C82,36 80,58 66,72 C54,84 36,88 24,84",72,22)],
  "て":[SD("M16,32 L84,32",16,32), SD("M50,18 L50,46 C52,58 62,68 72,70",50,18)],
  "と":[SD("M44,18 L44,54",44,18), SD("M24,54 C32,62 52,72 68,62 C78,56 78,40 66,30",24,54)],
  // ナ行
  "な":[SD("M20,28 L80,28",20,28), SD("M50,16 L50,52",50,16), SD("M28,52 L72,52",28,52), SD("M64,52 C72,66 70,80 58,88 C44,94 28,88 22,78 C16,66 22,56 36,54 C48,52 62,58 64,70",64,52)],
  "に":[SD("M26,18 L26,82",26,18), SD("M26,50 L74,50",26,50), SD("M74,36 L74,82",74,36)],
  "ぬ":[SD("M28,18 C30,36 28,56 22,74 C18,82 14,84 12,82",28,18), SD("M56,18 C62,30 64,48 56,62 C48,76 38,80 28,76 C44,68 62,56 64,42 C66,32 56,22 44,22",56,18)],
  "ね":[SD("M26,18 L26,82",26,18), SD("M26,46 C42,36 66,36 74,48 C80,58 78,74 60,82 C46,88 32,80 26,72",26,46)],
  "の":[SD("M64,20 C76,28 80,44 74,58 C66,74 48,82 34,78 C20,72 14,56 18,44 C22,30 36,22 50,24 C62,26 72,36 72,50",64,20)],
  // ハ行
  "は":[SD("M26,18 L26,82",26,18), SD("M26,46 L74,36",26,46), SD("M74,36 C80,48 80,64 72,74 C64,82 52,84 44,78",74,36)],
  "ひ":[SD("M50,16 C58,26 62,46 56,62 C50,76 36,84 24,80 C12,76 10,62 16,50 C22,38 40,34 56,40",50,16)],
  "ふ":[SD("M28,22 L72,22",28,22), SD("M24,40 C36,30 64,30 76,40",24,40), SD("M20,62 C30,54 46,52 46,64 C46,76 34,82 24,78",20,62), SD("M54,62 C64,54 78,58 80,68 C82,78 72,84 60,80",54,62)],
  "へ":[SD("M20,60 C36,28 58,22 80,50",20,60)],
  "ほ":[SD("M26,18 L26,82",26,18), SD("M16,48 L84,48",16,48), SD("M58,18 C64,28 64,42 58,48",58,18), SD("M58,56 C66,68 68,78 60,86 C52,92 40,90 32,82",58,56)],
  // マ行
  "ま":[SD("M16,28 L84,28",16,28), SD("M16,50 L84,50",16,50), SD("M50,28 C58,40 60,58 52,72 C44,84 32,88 22,84",50,28)],
  "み":[SD("M24,22 C26,38 24,56 18,72",24,22), SD("M56,18 C64,30 66,50 56,64 C46,78 32,82 22,78",56,18), SD("M48,56 C58,64 72,68 80,60",48,56)],
  "む":[SD("M38,16 L38,52",38,16), SD("M18,40 L82,40",18,40), SD("M52,40 C64,50 68,66 60,76 C52,86 36,88 26,80 C16,72 14,58 22,50 C30,42 46,42 52,50",52,40)],
  "め":[SD("M28,20 C30,36 28,56 22,70",28,20), SD("M58,18 C66,30 68,48 60,62 C50,76 36,80 26,76 C44,70 62,60 64,46 C66,34 56,24 44,24",58,18)],
  "も":[SD("M16,30 L84,30",16,30), SD("M16,52 L84,52",16,52), SD("M50,30 C58,44 60,60 52,72 C44,82 34,86 26,82",50,30)],
  // ヤ行
  "や":[SD("M50,18 C54,32 54,50 48,64",50,18), SD("M22,44 C34,36 54,32 64,40 C74,48 74,62 64,68",22,44), SD("M28,74 L72,74",28,74)],
  "ゆ":[SD("M26,30 C28,44 24,60 18,74",26,30), SD("M46,22 L80,22 L80,54 L46,54",46,22), SD("M62,54 C64,66 60,78 52,84 C44,90 36,86 30,78",62,54)],
  "よ":[SD("M16,36 L84,36",16,36), SD("M50,36 L50,58 C50,68 60,76 70,78",50,36), SD("M16,70 L84,70",16,70)],
  // ラ行
  "ら":[SD("M16,28 L84,28",16,28), SD("M50,28 C60,40 64,58 56,70 C48,82 34,86 24,82",50,28)],
  "り":[SD("M36,18 C38,36 34,58 26,76",36,18), SD("M64,18 C66,36 64,58 56,70 C48,82 38,84 30,80",64,18)],
  "る":[SD("M50,18 C62,26 68,42 62,56 C56,68 42,74 32,68 C20,60 18,44 28,34 C38,24 54,24 62,34 C68,42 66,54 56,62",50,18), SD("M56,62 C62,70 60,78 52,82 C44,86 34,82 28,74",56,62)],
  "れ":[SD("M26,18 L26,82",26,18), SD("M26,46 C42,38 66,38 74,50 C82,60 78,74 60,82 C46,88 32,80 26,72",26,46)],
  "ろ":[SD("M18,30 C36,22 66,22 80,32 C86,40 82,54 68,64 C56,72 40,72 30,62 C20,54 20,40 34,34",18,30)],
  // ワ行
  "わ":[SD("M26,18 L26,82",26,18), SD("M26,46 C42,36 66,36 74,48 C82,58 78,72 62,78 C48,84 34,78 28,68",26,46)],
  "を":[SD("M14,24 L86,24",14,24), SD("M14,44 L86,44",14,44), SD("M50,44 C60,56 64,70 56,80 C48,90 34,90 26,82",50,44)],
  "ん":[SD("M50,18 C58,28 62,46 54,60 C46,72 32,76 22,70",50,18)],
  // 濁音
  "が":[SD("M26,18 L26,82",26,18), SD("M18,50 L82,50",18,50), SD("M64,18 C70,32 70,56 60,70 C52,82 42,86 36,84",64,18)],
  "ぎ":[SD("M18,24 L82,24",18,24), SD("M18,46 L82,46",18,46), SD("M50,24 C54,32 54,40 50,48",50,24), SD("M36,58 C24,66 18,78 26,86 C34,92 52,90 64,82 C74,74 76,62 64,54 C56,48 40,50 36,58",36,58)],
  "ぐ":[SD("M68,16 C76,28 76,50 62,64 C52,74 38,80 26,82",68,16)],
  "ざ":[SD("M18,28 L82,28",18,28), SD("M18,52 L82,52",18,52), SD("M55,28 C62,44 60,62 50,74 C42,84 32,88 24,84",55,28)],
  "ず":[SD("M18,28 L82,28",18,28), SD("M50,16 C52,30 54,54 50,68 C46,78 38,82 30,76",50,16)],
  "だ":[SD("M18,28 L82,28",18,28), SD("M50,16 L50,52",50,16), SD("M28,52 L72,52",28,52), SD("M64,52 C72,64 70,76 58,84 C48,90 38,90 32,84",64,52)],
  "ぢ":[SD("M18,26 L82,26",18,26), SD("M55,18 C64,32 66,50 56,64 C48,76 36,80 26,76 C18,70 16,58 22,50 C28,40 44,36 58,42",55,18)],
  "づ":[SD("M72,22 C82,36 80,58 66,72 C54,84 36,88 24,84",72,22)],
  "で":[SD("M16,30 L84,30",16,30), SD("M50,18 L50,46 C52,58 62,68 72,70",50,18)],
  "ど":[SD("M44,18 L44,54",44,18), SD("M24,54 C32,62 52,72 68,62 C78,56 78,40 66,30",24,54)],
  "ば":[SD("M26,18 L26,82",26,18), SD("M26,46 L74,36",26,46), SD("M74,36 C80,48 80,64 72,74 C64,82 52,84 44,78",74,36)],
  "び":[SD("M50,16 C58,26 62,46 56,62 C50,76 36,84 24,80 C12,76 10,62 16,50 C22,38 40,34 56,40",50,16)],
  "ぶ":[SD("M28,22 L72,22",28,22), SD("M24,40 C36,30 64,30 76,40",24,40), SD("M20,62 C30,54 46,52 46,64 C46,76 34,82 24,78",20,62), SD("M54,62 C64,54 78,58 80,68 C82,78 72,84 60,80",54,62)],
};
